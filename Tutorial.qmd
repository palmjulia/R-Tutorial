...
- Docker Image gebaut mit `docker-compose build` oder gepullt mit `docker pull palmjulia/r-tutorial`
...
1) Selbstständiges Bearbeiten der Teilaufgabe
2) Gemeinsames besprechen der Lösung


## Schritt 1: BMI der Patienten berechnen
a) Observations für Körpergewicht und Körpergröße herunterladen 
b) Observation Ressourcen verflachen
c) Daten vorbereiten
d) BMI berechnen

## Schritt 2: Herausfinden, wer Bluthochdruck als Komorbiditätsdiagnose hat
a) Encounter- und Condition-Ressourcen über POST herunterladen
b) Encounter Ressourcen verflachen
c) Condition Ressourcen verflachen
